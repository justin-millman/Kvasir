    ...
    public class PreDefinedEntityTests {
        ...
        [TestMethod] public void ReferenceToNonPreDefinedEntity_IsError() {
            ...
            translate.Should().FailWith<PreDefinedReferenceException>()
                ...
                .WithProblem("a Pre-Defined Entity cannot reference non-Pre-Defined type `UT.Kvasir.Translation.PreDefinedEntities+CapnCrunch.Date`")
                .EndMessage();
        }
        ...
        [TestMethod] public void AggregateNestedReferenceToNonPreDefinedEntity_IsError() {
            ...
            // Assert
            translate.Should().FailWith<PreDefinedReferenceException>()
                .WithLocation("`CapnCrunch` → `Article` (from \"ProposedIn\") → Author")
                .WithProblem("a Pre-Defined Entity cannot reference non-Pre-Defined type `UT.Kvasir.Translation.PreDefinedEntities+StageOfGrief.Psychologist`")
                .EndMessage();
        }
        ...
        [TestMethod] public void AggregateNestedReferenceToNonPreDefinedEntity_PostMemoization_IsError() {
            ...
            // Assert
            translate.Should().FailWith<PreDefinedReferenceException>()
                .WithLocation("`Stooge` → `FilmDeal` (from \"InitialDeal\") → Film")
                .WithProblem("a Pre-Defined Entity cannot reference non-Pre-Defined type `UT.Kvasir.Translation.PreDefinedEntities+Stooge.Film`")
                .EndMessage();
        }
        ...
        [TestMethod] public void RelationToNonPreDefinedEntity_IsError() {
            ...
            // Assert
            translate.Should().FailWith<PreDefinedReferenceException>()
                .WithLocation("`CivVIYield` → ProducedBy")
                .WithProblem("a Pre-Defined Entity cannot contain a Relation involving non-Pre-Defined type `UT.Kvasir.Translation.PreDefinedEntities+CivVIYield.District`")
                .EndMessage();
        }
        ...
        [TestMethod] public void AggregateNestedRelationToNonPreDefinedEntity_IsError() {
            ...
            translate.Should().FailWith<PreDefinedReferenceException>()
                ...
                .WithProblem("a Pre-Defined Entity cannot contain a Relation involving non-Pre-Defined type `UT.Kvasir.Translation.PreDefinedEntities+StateOfMatter.Scientist`")
                .EndMessage();
        }
        ...
        [TestMethod] public void AggregateNestedRelationToNonPreDefinedEntity_PostMemoization_IsError() {
            ...
            translate.Should().FailWith<PreDefinedReferenceException>()
                ...
                .WithProblem("a Pre-Defined Entity cannot contain a Relation involving non-Pre-Defined type `UT.Kvasir.Translation.PreDefinedEntities+Primate.Study`")
                .EndMessage();
        }
    }
}

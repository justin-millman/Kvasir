...
namespace UT.Kvasir.Translation {
    ...
    internal static class FieldClusivity {
        ...
        [PreDefined] public class AnimalPhylum {
            ...
            public static AnimalPhylum Porifera { set { throw new NotImplementedException(); } }
    ...
    internal static class SignednessConstraints {
        public static class IsPositive {
            ...
            [PreDefined] public class Russo {
                ...
                public Russo Alex { get; } = new Russo(1411125, "Alex Russo", "Selena Gomez", 106, Wizardry.Current);
                [Check.IsPositive] public Russo Justin { get; } = new Russo(1273708, "Justin Russo", "David Henrie", 106, Wizardry.Past);
                public Russo Max { get; } = new Russo(1545471, "Max Russo", "Jake T. Austin", 106, Wizardry.Past);
                public Russo Jerry { get; } = new Russo(217936, "Jerry Russo", "David DeLuise", 106, Wizardry.Past);
                public Russo Theresa { get; } = new Russo(133566, "Theresa Russo", "Maria Canals-Barrera", 106, Wizardry.Never);
                public Russo Kelbo { get; } = new Russo(307531, "Kelbo Russo", "Jeff Garlin", 3, Wizardry.Current);
    ...
    internal static class ComparisonConstraints {
        ...
        public static class IsNot {
            ...
            [PreDefined] public class Sexuality {
                ...
                public Sexuality Heterosexuality { get; } = new Sexuality("heterosexuality");
                public Sexuality Homosexuality { get; } = new Sexuality("homosexuality");
                [Check.IsNot(100)] public Sexuality Bisexuality { get; } = new Sexuality("bisexuality");
                public Sexuality Pansexuality { get; } = new Sexuality("pansexuality");
                public Sexuality Asexuality { get; } = new Sexuality("asexuality");
                public Sexuality Sapiosexuality { get; } = new Sexuality("sapiosexuality");
                public Sexuality Polysexuality { get; } = new Sexuality("polysexuality");
    ...
    internal static class StringLengthConstraints {
        internal static class IsNonEmpty {
            ...
            [PreDefined] public class IronChef {
                ...
                public IronChef Kenichi { get; } = new IronChef("Chen Kenichi", Show.Japanese, 72.6);
                public IronChef Ishinabe { get; } = new IronChef("Yutaka Ishiabe", Show.Japanese, 87.5);
                public IronChef Sakai { get; } = new IronChef("Hiroyuki Sakai", Show.Japanese, 82.4);
                public IronChef Kobe { get; } = new IronChef("Masahiko Sabe", Show.Japanese, 68.8);
                public IronChef Michiba { get; } = new IronChef("Rokusaburo Michiba", Show.Japanese, 85.9);
                public IronChef Nakamura { get; } = new IronChef("Koumei Nakamura", Show.Japanese, 66.2);
                public IronChef MorimotoJ { get; } = new IronChef("Masaharu Morimoto", Show.Japanese, 67.3);
                public IronChef Batali { get; } = new IronChef("Mario Batali", Show.American, 79.2);
                public IronChef Cora { get; } = new IronChef("Cat Cora", Show.American, 63.2);
                public IronChef Flay { get; } = new IronChef("Bobby Flay", Show.American, 72.1);
                public IronChef Forgione { get; } = new IronChef("Marc Forgione", Show.American, 53.0);
                public IronChef Garces { get; } = new IronChef("Jose Garces", Show.American, 69.6);
                [Check.IsNonEmpty] public IronChef Guarnaschelli { get; } = new IronChef("Alex Guarnaschelli", Show.American, 63.6);
                public IronChef Izard { get; } = new IronChef("Stephanie Izard", Show.American, 100.0);
                public IronChef MorimotoA { get; } = new IronChef("Masaharu Morimoto", Show.American, 60.2);
                public IronChef Puck { get; } = new IronChef("Wolfgang Puck", Show.American, 100.0);
                public IronChef Symon { get; } = new IronChef("Michael Symon", Show.American, 82.1);
                public IronChef Zakarian { get; } = new IronChef("Geoffrey Zakarian", Show.American, 64.3);
        ...
        internal static class LengthIsBetween {
            ...
            [PreDefined] public class HighSchoolMusical {
                [PrimaryKey] public int Index { get; private set; }
                public string Title { get; private set; }
                public DateTime Premiere { get; private set; }
                public bool WasDCOM { get; private set; }
    ...
    internal static class Reconstitution {
        ...
        [PreDefined] public class Vertebra {
            ...
            [PrimaryKey] public Guid ID { get; private init; }
            public string Designation { get; private init; }
            public Section SpinalSegment { get; private init; }
        ...
        [PreDefined] public class Tortilla {
            [PrimaryKey] public string Name { get; private init; }
            public bool IsAuthenticMexican { get; private init; }
            public decimal? CostcoCost { get; private init; }
        ...
        [PreDefined] public class Organelle {
            ...
            [Column(1)] public string? AKA { get; private set; }
